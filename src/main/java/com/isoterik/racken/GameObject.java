...
public final class GameObject {
    ...
    private final ComponentIteratorPool componentIteratorPool;
    ...
    /**
     * Sets the scene where this game object will be hosted.
     * This method is called internally. Do not call it directly!
     ...
     * The component's {@link Component#attach()} is called before the other existing components are notified.
     * The component is added after the other existing components are notified.
     ...
     * The other existing components are notified after the component is removed.
     * The component is detached after the other existing components are notified.
     * <strong>Note:</strong> a component can remove itself.
     * @param component the component to remove.
     * @return true if the component was removed. false otherwise
     */
    public boolean removeComponent(Component component) {
        if (components.contains(component, true) && components.removeValue(component, true)) {
            for (Component comp : components)
    ...
    /**
     * Removes the first component found for a given type that is attached to this host game object.
     * <strong>Note:</strong> a component can remove itself.
    ...
    /**
     * Removes all the components of a given type from this game object.
     * @param componentClass the class of the component
     * @param <T> the type of component
     */
     ...
     * The method accepts an array and uses that to return the components.
     * @param out the output array. if null, a new array will be created
     * @return all the components attached to this game object.
     */
    public Array<Component> getComponents(Array<Component> out) {
        if (out == null)
            out = new Array<>();
    ...
    /**
     * A pool of ArrayIterators for iterating through components.
     */
