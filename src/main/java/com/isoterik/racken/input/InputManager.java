...
public class InputManager extends InputAdapter implements GestureDetector.GestureListener {
	 ...
	 * <strong>Note:</strong> this will not modify existing mappings. If you want to update an existing mapping,
	 * use {@link #updateMapping(String, ITrigger, ITrigger...)}
	 ...
	 * <strong>Note:</strong> this will not remove the mapping itself. If you want to remove an existing mapping use
	 * {@link #removeMapping(String)} instead
	 * @param mappingName the name of the mapping
	...
	/**
	 * Maps a touch listener to a given mapping
	 * @param mappingName the mapping name
	...
	/**
	 * Maps a key listener to a given mapping
	 * @param mappingName the mapping name
	...
	/**
	 * Maps a gesture listener to a given mapping
	 * @param mappingName the mapping name
	 ...
	 * The trigger and the listener must be for the same type
	 * <strong>Note:</strong> listeners cannot be mapped this way, use
	 * {@link #mapListener(String, InputListener, InputListener...)} to map listeners
	...
	/**
	 * Adds a touch listener to a touch trigger.
	 * @param trigger the touch trigger
	 * @param listener the touch listener
	 */
	...
	/**
	 * Adds a key listener to a key trigger
	...
	/**
	 * Adds a gesture listener to a gesture trigger
	 * @param trigger the gesture trigger
	 * @param listener the gesture listener
	 */
	...
	/**
	 * Removes the listener registered with a given trigger.
	 * <strong>Note:</strong> this won't remove mapped listener. Use
	 * {@link #removeMappedListener(String, InputListener)} to remove mapped listener.
	...
	/**
	 * Removes the touch listener registered with a given touch trigger
	 * @param trigger the touch trigger
	 */
	public void removeTouchListener(TouchTrigger trigger) {
		if (!touchListeners.containsKey(trigger))
			return;
	 ...
	 * @param touchListener the touch listener
	 */
	public void removeTouchListener(ITouchListener touchListener)
	{ touchListeners.removeValue(touchListener, true); }

	/**
	 * Removes all touch listeners of a given event type
	 * <strong>Note:</strong> this won't remove mapped listeners.
	...
	/**
	 * Removes the key listener registered to the given key trigger
	 * @param trigger the key trigger
	 */
	public void removeKeyListener(KeyTrigger trigger) {
		if (!keyListeners.containsKey(trigger))
			return;
	...
	/**
	 * Removes the gesture listener registered with the given gesture trigger
	 * @param trigger the gesture trigger
	 */
	public void removeGestureListener(GestureTrigger trigger) {
		if (!gestureListeners.containsKey(trigger))
			return;
	 ...
	 */
	public void removeGestureListener(IGestureListener gestureListener)
	 ...
	 * <strong>Note:</strong> this won't remove mapped listeners. Use
	 * {@link #removeAllMappedListeners()} to remove all mapped listeners
	 */
	...
	/**
	 * Called every frame internally. This is where polled triggers gets evaluated and fired if need be.
	 ...
	 * @return {@code true} if the finger represented by the given pointer index or the mouse is currently touching the
	 ...
	 *
	 * @param pointer the pointer index for a finger
	 * @return the difference between the given pointer location and the last pointer location on the
	...
	/**
	 *
	 * @return the difference between the current pointer location and the last pointer location on the
	 * x-axis (in world units).
	 */
